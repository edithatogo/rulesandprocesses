...
- [x] **Track: Publication and demo closeout**
*Link: [./archive/publication_closeout_20260709/](./archive/publication_closeout_20260709/)*
...
*Archived link: [./archive/core_model_demonstrator_20260717/](./archive/core_model_demonstrator_20260717/)*
...
`external/MAINTAINER_MONITORING.md`. Fork source of truth remains
`external/FORK_LOCAL_STATUS.md`; fyi-cli integration remains deferred in
`external/fyi-cli/INTEGRATION_NOTES.md`.
