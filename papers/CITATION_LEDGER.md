...
| SW-FOIO-01 | https://github.com/edithatogo/foi-o; `CITATION.cff`; v0.8.1 | FOI-O ontology, schemas, V2 extraction contract, and process model | All FOI papers | Zenodo version DOI [`10.5281/zenodo.21360138`](https://doi.org/10.5281/zenodo.21360138), concept DOI [`10.5281/zenodo.21360137`](https://doi.org/10.5281/zenodo.21360137), verified 2026-07-15; release evidence bundle and paper authorization remain gated by `edithatogo/foi-o#27` and `edithatogo/rac-conformance#31` |
...
| SW-RAC-01 | https://github.com/edithatogo/rac-conformance; `CITATION.cff`; v0.2.0; `35fdebdd6ca3ad0a254ca0b3ec5b7466b7db3fe5` | Policy-interchange conformance and evidence harness | Methods and reproducibility | GitHub archive SHA-256 `07743bb7e4be3749f89564d8cb0184372a76d26af426181ccdcd3115e8d667ff`; Zenodo DOI remains pending human deposit |
