...
| SW-FOIPROCESS-01 | https://github.com/edithatogo/foi-process; `CITATION.cff`; v0.1.0 | Deterministic FOI integration, replay, OCEL/process projections, and provenance | Integration and process-methods evidence | Cite exact release tag and SHA; Zenodo DOI is pending human deposit; FOI-O remains semantic authority |
