...
| `TheAxiomFoundation/rulespec-nz` (KiwiSaver compile blocker) | `external/axiom/UPSTREAM_FEEDBACK.md` | `submitted` + fix PR | [Issue #79](https://github.com/TheAxiomFoundation/rulespec-nz/issues/79); fix [PR #80](https://github.com/TheAxiomFoundation/rulespec-nz/pull/80) (indexed `values` map; compile verified) | `TheAxiomFoundation/rulespec-nz#79` / `#80` | `pass` (local compile) | Agent (authorized) | Await maintainer review of PR #80 |
